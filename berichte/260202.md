...
Zeigt die Deatils zum Modul. z.b.: Beschreibung       
...
Lädt das Modul, dass den Webseiten-Titel ausliest.      
...
## Übung (nmap FTP scan)
### Aufgabe:      
Wiederhole den nmap vuln scan auf den FTP Port. Verwende:         
...
-> Die Ausgabe sieht aus wie gewünscht        
...
Auführen des aktiven Modules:      
IP: 192.168.112.128       
-> dies hat bei mir leider noch nicht funktioniert, wegen dem Ende der Stunde konnte ich den Fehler leider noch nicht beheben.            
Fehlerhafte Ausgabe:        
![](https://github.com/user-attachments/assets/f0d536f3-6ac4-444c-a01f-b98ca694c54f)        
