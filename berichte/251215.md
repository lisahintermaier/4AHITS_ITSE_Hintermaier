...
### Nutzen für Hacker: 
Im Jahr 2011 wurde ein manipuliertes vsftpd‑Release verbreitet. Diese Version enthielt eine Backdoor mit folgendem Verhalten:
Wenn sich ein Benutzer mit einem Benutzernamen anmeldet, der ein :) enthält öffnet der FTP‑Server zusätzlich einen Shell‑Zugriff auf Port 6200 diese Shell läuft mit Root‑Rechten     
Das bedeutet: Remote Code Execution als root, ohne gültige Zugangsdaten.
...
Führe einen online password guessing attack auf den FTP von Metasploitable aus. Verwende dafür hydra ein geeignetes und bereits in Kali installiertes Penetration Testing Tool.
...
### Anmerkung: der Befehl funktioniert nicht, wird in der nächsten Stunde erledigt.     
