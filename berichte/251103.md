...
<table border="1" cellpadding="8" cellspacing="0">
  ...
  <tbody>
    <tr>
      ...
      <td>schnelle Prüfung von TCP-Ports</td>
      <td>
        HTTP: <code>telnet 192.168.17.51 80</code> → dann <code>HEAD / HTTP/1.0</code> + <code>Host: 192.168.18.51</code> + 2 leere Zeile
      </td>
      <td>Einfach & interaktiv; manuelles Senden von Text nötig.
      </td>
    </tr>
    ...
    <tr>
      ...
      <td>
        Port-Check: <code>nc -vz 192.168.18.51 22</code><br>
        HTTP Header:<br>
        <code>printf 'HEAD / HTTP/1.0\r\nHost: 192.168.18.51\r\nConnection: close\r\n\r\n' | nc 192.168.18.51 80</code>
      </td>
      <td>Sehr flexibel — gut für Skripte.
      <code>-w</code> für Timeout; <code>-z</code> nur „scan“ (no I/O).</td>
    </tr>

    <tr>
      <td><code>curl</code></td>
      <td>HTTP(S) Header & Fingerprint, Web-Service Tests</td>
      <td>
        Kurz Header: <code>curl -sI http://192.168.18.51/</code><br>
        Ganze Antwort sichtbar 
      </td>
      <td>Ideal für Webserver: zeigt <code>Server:</code>-Header und TLS-Infos. 
    </tr>
  </tbody>
</table>
